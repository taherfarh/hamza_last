...
return LoadingPage(
  ...
  return ListView.builder(
          itemCount: m.length,
          itemBuilder: (context, index) => m[index] == "false"  ? Gap(1): Padding(
            padding: const EdgeInsets.all(8.0),
            child:  GestureDetector(
                    onTap: () {
                      navigateToSecondPage(context, VideoListViews(coursename: m[index],));
                      print(m[index]);
                    },
                    child: Container(
                      width: width * 0.6,
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                                fontSize:
                                    ResponsiveSize(context: context, size: 25)
                                        .size,
