  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context).pushNamed(Routes.detailsPage, arguments: {
            'id': state
                .popularServicesStatue.model?.popularServices?.data?[index].id
          });
        },
        child: Container(
                ...
                Stack(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.network(
                        "${AppStrings.imageString}${state.popularServicesStatue.model?.popularServices?.data?[index].image ?? "_"}",
                        height: 120,
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          state.popularServicesStatue.model?.popularServices
                                  ?.data?[index].tags![0].name ??
                              "_",
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 12,
