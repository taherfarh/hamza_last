...
import 'package:client_app/features/payment/data/model/params/filter_order_params.dart';
...
class AllBookingWidget extends StatelessWidget {
  final String selectedFilter;

  const AllBookingWidget({super.key, required this.selectedFilter});
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<PaymentBloc, PaymentState>(
      ...
      builder: (context, state) {
        return state.allOrderStatus.isSuccess()
            ? state.allOrderStatus.model!.orders!.data!.isNotEmpty
                ?ListView.builder(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context)
                          .pushNamed(Routes.bookingDetails, arguments: {
                        "orderId":
