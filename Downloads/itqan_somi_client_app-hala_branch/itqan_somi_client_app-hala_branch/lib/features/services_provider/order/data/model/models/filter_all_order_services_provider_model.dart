...
FilterServicesProviderOrderModel FilterServicesProviderOrderModelFromJson(String str) => FilterServicesProviderOrderModel.fromJson(json.decode(str));

String FilterServicesProviderOrderModelToJson(FilterServicesProviderOrderModel data) => json.encode(data.toJson());

class FilterServicesProviderOrderModel {
  final bool? success;
  final String? message;
  final Orders? orders;

  FilterServicesProviderOrderModel({
    this.success,
    this.message,
    this.orders,
  });

  factory FilterServicesProviderOrderModel.fromJson(Map<String, dynamic> json) => FilterServicesProviderOrderModel(
