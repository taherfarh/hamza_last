...
//
//     final showOrderServicesProviderModel = showOrderServicesProviderModelFromJson(jsonString);

import 'dart:convert';

ShowOrderServicesProviderModel showOrderServicesProviderModelFromJson(String str) => ShowOrderServicesProviderModel.fromJson(json.decode(str));

String showOrderServicesProviderModelToJson(ShowOrderServicesProviderModel data) => json.encode(data.toJson());

class ShowOrderServicesProviderModel {
  final bool? success;
  final String? message;
  final Order? order;

  ShowOrderServicesProviderModel({
    this.success,
    this.message,
    this.order,
  });

  factory ShowOrderServicesProviderModel.fromJson(Map<String, dynamic> json) => ShowOrderServicesProviderModel(
...
class OrderItem {
  ...
  final List<OrderItemAddition>? orderItemAdditions;
  ...
  factory OrderItem.fromJson(Map<String, dynamic> json) => OrderItem(
    ...
    orderItemAdditions: json["order_item_additions"] == null ? [] : List<OrderItemAddition>.from(json["order_item_additions"]!.map((x) => OrderItemAddition.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "order_item_additions": orderItemAdditions == null ? [] : List<dynamic>.from(orderItemAdditions!.map((x) => x.toJson())),
  };
}
...
class OrderItemAddition {
  ...
  factory OrderItemAddition.fromJson(Map<String, dynamic> json) => OrderItemAddition(
    id: json["id"],
